...
class Vector3 {
  constructor(opt_src) {
      ...
      if (opt_src && typeof opt_src === 'object') {
          if(isNaN(opt_src[0])) v[0] = 0;
          else v[0] = opt_src[0];

          if (isNaN(opt_src[1])) v[1] = 0;
          else v[1] = opt_src[1];

          if(isNaN(opt_src[2])) v[2] = 0; 
          else v[2] = opt_src[2];
      }
      this.elements = v;
  }
  ...
  static dot(other1, other2) {
      ...
      //||v1||*||v2||
      // Don't delete the return statement.
      let d = other1.elements[0] * other2.elements[0] + // x components
              other1.elements[1] * other2.elements[1] + // y components
              other1.elements[2] * other2.elements[2];  // z components
      return d;
  }
  ...
  static cross(other1, other2) {
      //let a_x = 1, a_y = 0, a_z = NaN
      //let b_x = 0, b_y = 1, b_z = NaN
      let a_x = other1.elements[0], a_y = other1.elements[1], a_z = other1.elements[2];
      let b_x = other2.elements[0], b_y = other2.elements[1], b_z = other2.elements[2];

      // Calculate the cross product components
      let x = a_y * b_z - a_z * b_y;
      let y = a_z * b_x - a_x * b_z;
      let z = a_x * b_y - a_y * b_x;
      // Create a new vector for the cross product
  ...
  mag() {
      return Math.sqrt(this.elements[0] * this.elements[0] +
          this.elements[1] * this.elements[1] + this.elements[2]* this.elements[2])
  };
